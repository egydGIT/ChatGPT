...
majd meghatározza és kiírja az adott számhoz tartozó Collatz-sorozat hosszát és a sorozat elemeit!

A Collatz-sorozatot a következő módon hozzuk létre:
...
Collatz-sorozat hossza: 9
Collatz-sorozat elemei: 6, 3, 10, 5, 16, 8, 4, 2, 1

Példa:
Ha a felhasználó beírja a számot: 27
A programnak ki kell írnia az eredményt:
Collatz-sorozat hossza: 111
Collatz-sorozat elemei: 27, 82, 41, 124, 62, 31, 94, 47, 142, 71, 214, 107, 322, 161, 484, 242, 121, 364, 182, 91, 274,
...
Tipp:
Használj egy ciklust a Collatz-sorozat elemeinek meghatározásához.
...
public class Collatz {
    ...
    public void collatz(int number) {
        ...
        System.out.println("Collatz-sorozat hossza: " + results.size());
        System.out.println("Collatz-sorozat elemei: " + results);
    }
    ...
    public static void main(String[] args) {
        ...
        Collatz-sorozat hossza: 112
        Collatz-sorozat elemei: [27, 82, 41, 124, 62, 31, 94, 47, 142, 71,
